...
## Unreleased <!-- release/browser-extension-v5.4 -->
...
- Enabled alphabetical import sorting via ESLint `sort-imports` and `import/order` rules
  in declarative-converter subdirectory configs.
...
[4.0.5]: https://github.com/AdguardTeam/tsurlfilter/releases/tag/tsurlfilter-v4.0.5
...
[3.4.6]: https://github.com/AdguardTeam/tsurlfilter/releases/tag/tsurlfilter-v3.4.6
